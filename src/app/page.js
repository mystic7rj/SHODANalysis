...
export default function Home() 
{
  ...
  return (
    <div className="bg-mainbg h-screen w-screen bg-cover flex items-center flex-col p-10">
      ...
      <div>
        {" "}
        <h2 className=" text-4xl text-center font-semibold font-[Arial]">
          Unlocking Intelligence, Unleashing Insights{" "}
        </h2>{" "}
      </div>
      <div>
        <br />
      ...
      <div className=" rounded-[8px] p-10 mt-9">
        <div>
          ...
          />{" "}
          <button
            className="bg-cyan-600 p-2 rounded size-lg"
            onClick={() => {
              callDNSAPI();
            }}
          >
      ...
      <div className="flex flex-col w-screen">
        ...
        {dnsData && (
          <div className="bg-white/75 text-gray-900 rounded-xl m-6 border p-6">
            <h1 className="text-2xl bold text-black">
